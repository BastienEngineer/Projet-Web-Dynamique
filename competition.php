    ...
    <div class="carousel-inner" role="listbox">
      ...
      <!--First slide-->
        ...
        <div class="carousel-item active">
            ...
            <div class="col-md-4">
                    <div class="card mb-2">
                        <img class="card-img-top" src="img/basket.jpg"
                        alt="Card image cap">
        ...
        <div class="carousel-item">
            <div class= "row">
                ...
                <div class="col-md-4">
                    <div class="card mb-2">
                    <img class="card-img-top" src="img/rugby.jpg"
                        alt="Card image cap">
                        <div class="card-body text-center">
        ...
        <div class="carousel-item">
            <div class= "row">
                ...
                <div class="col-md-4">
                    <div class="card mb-2">
                    <img class="card-img-top" src="img/natation.jpg"
                        alt="Card image cap">
                        <div class="card-body text-center">
        ...
        <div class="carousel-item">
            <div class= "row">
                ...
                <div class="col-md-4">
                    <div class="card mb-2">
                    <img class="card-img-top" src="img/plongeon.jpg"
                        alt="Card image cap">
                        <div class="card-body text-center">
